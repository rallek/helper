...
use RK\HelperModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKHelperModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $controllerReference = new ControllerReference('RKHelperModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@RKHelperModule/Block/item_modify.html.twig';
    }

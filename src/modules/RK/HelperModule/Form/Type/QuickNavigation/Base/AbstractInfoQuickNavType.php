...
/**
 * Info quick navigation form type base class.
 */
abstract class AbstractInfoQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('info', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' =>             [
                    $this->__('Info title') => 'infoTitle',
                    $this->__('Info description') => 'infoDescription',
                    $this->__('Info locale') => 'infoLocale',
    ...
    {
        return 'rkhelpermodule_infoquicknav';
    }
}

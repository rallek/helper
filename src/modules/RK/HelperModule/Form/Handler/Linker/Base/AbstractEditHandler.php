...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create('RK\HelperModule\Form\Type\LinkerType', $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'linker', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];

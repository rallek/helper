...
namespace RK\HelperModule\Form\Handler\Image\Base;

use RK\HelperModule\Form\Handler\Common\EditHandler;
use RK\HelperModule\Form\Type\ImageType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKHelperModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'image', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];

...
abstract class AbstractImageFormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents()
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'rkhelpermodule.form_aware_hook.images.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'rkhelpermodule.form_aware_hook.images.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'rkhelpermodule.form_aware_hook.images.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'rkhelpermodule.form_aware_hook.images.process_delete'
        ];
    }
}

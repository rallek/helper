...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    public function display()
    {
        ...
        // create query
        $orderBy = $this->container->get('rk_helper_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('rk_helper_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);

...
namespace RK\HelperModule\Traits;
...
trait EntityWorkflowTrait
{
    ...
    {
        $entityClass = 'RKHelperModule:' . ucfirst($this->get_objectType()) . 'Entity';
    ...
    public function initWorkflow($forceLoading = false)
    {
        ...
        $workflowHelper = $container->get('rk_helper_module.workflow_helper');
        ...
        if (($loadingRequired && !$isReuse) || $forceLoading) {
            $result = Zikula_Workflow_Util::getWorkflowForObject($this, $objectType, $idColumn, 'RKHelperModule');
            if (!$result) {
    ...
    public function resetWorkflow()
    {
        ...
        $workflowHelper = ServiceUtil::get('rk_helper_module.workflow_helper');

...
abstract class AbstractCarouselRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'RK\HelperModule\Entity\CarouselEntity';
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('carousel', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('carousel', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('carousel', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of carousells to exclude (optional)
     *

 ...
 *
 * This is the base repository class for info entities.
 */
abstract class AbstractInfoRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'RK\HelperModule\Entity\InfoEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'infoTitle';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'RKHelperModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'infos', 'userid' => $userId];
     ...
     *
     * @return array|infoEntity Retrieved data array or infoEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved infoEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('info', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('info', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('info', $qb, $parameters);
        }

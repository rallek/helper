...
abstract class AbstractInfoRepository extends EntityRepository
{
    ...
    protected function getViewQuickNavParameters($context = '', $args = [])
    {
        ...
        $parameters['infoLocale'] = $this->getRequest()->query->get('infoLocale', '');
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\HelperModule\Entity\InfoEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKHelperModule', 'entity' => 'info'];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\HelperModule\Entity\InfoEntity', 'tbl');

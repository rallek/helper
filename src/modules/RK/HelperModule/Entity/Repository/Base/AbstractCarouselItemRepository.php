...
abstract class AbstractCarouselItemRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\HelperModule\Entity\CarouselItemEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKHelperModule', 'entity' => 'carousel item'];
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\HelperModule\Entity\CarouselItemEntity', 'tbl');

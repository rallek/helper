...
abstract class AbstractImageRepository extends EntityRepository
{
     ...
     */
    protected $defaultSortingField = 'imageTitle';
    ...
    public function getAdditionalTemplateParameters(ImageHelper $imageHelper, $context = '', $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            $objectType = 'image';
            $thumbRuntimeOptions = [];
            $thumbRuntimeOptions[$objectType . 'MyImage'] = $imageHelper->getRuntimeOptions($objectType, 'myImage', $context, $args);
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('RK\HelperModule\Entity\ImageEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'RKHelperModule', 'entity' => 'image'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'RKHelperModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'images', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('RK\HelperModule\Entity\ImageEntity', 'tbl');
     ...
     * @param int    $excludeId  Id of images to exclude (optional)
     *

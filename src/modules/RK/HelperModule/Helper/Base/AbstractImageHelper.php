    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKHelperModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), 'inset'),
        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKHelperModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKHelperModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }

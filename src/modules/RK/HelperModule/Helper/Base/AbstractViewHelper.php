...
abstract class AbstractViewHelper
{
    ...
    public function getViewTemplate($type, $func)
    {
        ...
        $template = '@RKHelperModule/' . ucfirst($type) . '/' . $func;
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('RKHelperModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = [];
            } else {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@RKHelperModule/includePdfHeader.html.twig') . $output . '</body></html>';

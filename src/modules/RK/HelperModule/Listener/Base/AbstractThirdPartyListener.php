...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/HelperModule/Resources/public/js/RKHelperModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkhelpermodule',
                'path' => 'modules/RK/HelperModule/Resources/scribite/TinyMce/rkhelpermodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rkhelpermodule',
                'path' => 'modules/RK/HelperModule/Resources/scribite/CKEditor/rkhelpermodule/',
                'file' => 'plugin.js',

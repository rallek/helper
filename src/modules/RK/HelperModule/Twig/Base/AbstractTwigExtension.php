...
namespace RK\HelperModule\Twig\Base;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rkhelpermodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rkhelpermodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rkhelpermodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rkhelpermodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rkhelpermodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('rkhelpermodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rkhelpermodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rkhelpermodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rkhelpermodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rkhelpermodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rkhelpermodule_fileSize }}
     *
    ...
    /**
     * The rkhelpermodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rkhelpermodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rkhelpermodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rkhelpermodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rkhelpermodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|rkhelpermodule_formattedTitle }}
     *

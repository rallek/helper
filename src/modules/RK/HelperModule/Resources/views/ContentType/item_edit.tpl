...
<div style="margin-left: 80px">
    <div class="form-group">
        {formlabel for='rKHelperModuleObjectType' __text='Object type' cssClass='col-sm-3 control-label'}
        <div class="col-sm-9">
    ...
    <div{* class="form-group"*}>
        <p>{gt text='Please select your item here. You can resort the dropdown list and reduce it\'s entries by applying filters. On the right side you will see a preview of the selected entry.' domain='rkhelpermodule'}</p>
        {rkhelpermoduleItemSelector id='id' group='data' objectType=$objectType}
    </div>
    ...
    <div{* class="form-group"*}>
        ...
        <div class="col-sm-9">
            ...
            <span class="help-block">{gt text='Example' domain='rkhelpermodule'}: <em>displaySpecial.html.twig</em></span>
            <span class="help-block">{gt text='Needs to be located in the "External/YourEntity/" directory.' domain='rkhelpermodule'}</span>
        </div>
    </div>
</div>

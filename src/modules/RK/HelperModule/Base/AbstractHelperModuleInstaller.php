...
abstract class AbstractHelperModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $uploadHelper = new \RK\HelperModule\Helper\UploadHelper($container->get('translator.default'), $container->get('session'), $container->get('liip_imagine.cache.manager'), $container->get('logger'), $container->get('zikula_users_module.current_user'), $container->get('zikula_extensions_module.api.variable'), $container->getParameter('datadir'));
